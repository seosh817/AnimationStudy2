package com.seosh817.animationpractice2.widget
...
import com.seosh817.animationpractice2.R
import com.seosh817.animationpractice2.utils.lerp
...
class HeartAnimationView @JvmOverloads constructor(
    ...
    fun execute() {
        Log.d(TAG, "drawableSize intrinsicWidth == ${drawable.intrinsicWidth}, intrinsicHeight == ${drawable.intrinsicHeight}")
        Log.d(TAG, "HeartAnimationView width == ${width}, height == ${height}")
        Log.d(TAG, "targetX lerp == ${lerp(drawableSize, width - drawableSize, random.nextFloat())}")
        Log.d(TAG, "targetY lerp == ${lerp(drawableSize, height / 2, random.nextFloat())}")
        Log.d(TAG, "random == ${random.nextFloat()}")
    ...
    companion object {
        val TAG: String = HeartAnimationView::class.java.simpleName
    }
